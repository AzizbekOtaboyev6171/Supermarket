...
@Schema(name = "UnitUpdateDTO", description = "Data Transfer Object (DTO) used for updating an existing unit. This includes all necessary details required to update an existing unit in the system.")
