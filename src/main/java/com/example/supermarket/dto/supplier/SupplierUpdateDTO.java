...
@Schema(name = "SupplierUpdateDTO", description = "Data Transfer Object (DTO) used for updating an existing supplier. This includes all necessary details to modify the supplier's information in the system.")
